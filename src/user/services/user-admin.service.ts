...
//                 uploadPublicId = uploadResult.public_id; // store the public_id to clean up if needed
//             }

//             // STEP 2: start DB transaction
//             return await this.dataSource.transaction(async (manager) => {
//                 const userRepository = manager.getRepository(User);
//                 const uploadRepository = manager.getRepository(Upload);
...
//             });
//         } catch (error) {
//             // STEP 3: if transaction fails, clean up uploaded file
//             if (uploadPublicId) {
...
//         let banned = this.bannedRepository.create({
//             reason: banUserDto.reason
//         });

//         user.banned = banned;

//         await this.bannedRepository.save(banned)
